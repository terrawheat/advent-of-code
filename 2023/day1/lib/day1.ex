defmodule Day1 do
  ...
  def detect_singular([a, nil]) do [a, a] end
  def detect_singular([nil, b]) do [b, b] end
  def detect_singular([a, b]) do [a, b] end
  ...
  def translate("one") do "1" end
  def translate("two") do "2" end
  def translate("three") do "3" end
  def translate("four") do "4" end
  def translate("five") do "5" end
  def translate("six") do "6" end
  def translate("seven") do "7" end
